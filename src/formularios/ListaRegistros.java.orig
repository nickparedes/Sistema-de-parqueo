...
public class ListaRegistros extends javax.swing.JFrame implements Serializable{
    ...
    public void mostrar (String [][] m){
        ...
        tablaRegistros.setModel(new javax.swing.table.DefaultTableModel(
            m,
            new String [] {
                "NOMBRE", "DNI", "PLACA", "FECHA", "HORA", "ESTACIONAMIENTO"
            }
        ));
    ...
    private void initComponents() {
        ...
        tablaRegistros.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        tablaRegistros.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "NOMBRE", "DNI", "PLACA", "HORA", "FECHA", "ESTACIONAMIENTO"
            }
        ));
        tablaRegistros.setGridColor(new java.awt.Color(204, 204, 255));
        tablaRegistros.setRowHeight(30);
        tablaRegistros.setSelectionBackground(new java.awt.Color(204, 255, 204));
